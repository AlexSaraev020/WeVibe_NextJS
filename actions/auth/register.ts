...
export const registerUser = async ({ userName, email, password, setSuccess, setFailure, router }: RegisterProps) => {
    try {
        const response = await axios.post('/api/auth/register', { username: userName, email, password });
