...
export default function DisplayFullUsername({
  ...
  return (
    <>
      ...
      {showFullUsername && (
        <div className="absolute transition-all break-all w-fit mx-2 z-20 duration-500 animate-fadeIn bg-zinc-800 border border-zinc-600 text-xs md:text-lg p-2 rounded-md left-0 top-20">
          <h2>{username}</h2>
        </div>
      )}
    </>
