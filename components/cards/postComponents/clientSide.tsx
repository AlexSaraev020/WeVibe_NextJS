    ...
    return (
        <>
            ...
            <div className='px-2 w-full flex flex-col gap-1'>
                <div className={`flex flex-col items-start w-full ${truncate ? 'truncate' : ''}`}>
                    <p className='text-sm md:text-lg'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Aperiam voluptates earum atque tenetur veritatis cupiditate nam velit? Explicabo, quia atque.</p>
                    <button className='text-xs md:text-md text-zinc-300/90' onClick={handleTruncate} type='button'>
