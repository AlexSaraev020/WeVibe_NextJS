    ...
    >
      <div className="relative">
        <input
          ...
          className="h-8 w-full animate-fadeIn rounded-full border-2 border-sky-700 bg-black/30 px-4 text-white shadow-glow-sm shadow-sky-500 transition-all duration-500 focus:shadow-glow focus:shadow-sky-500 focus:outline-none md:h-12"
        />
        <div className="absolute right-1 top-1/2 flex -translate-y-1/2 transform gap-2 md:right-2">
          ...
          >
            <CiSearch className="h-4 w-4 fill-sky-100/80 md:h-7 md:w-7" />
          </button>
        </div>
      </div>
    </form>
